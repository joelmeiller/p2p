...
@Component
@Order(3)
public class QMDataLoader implements CommandLineRunner {
	...
	public void run(String... strings) throws Exception {
		System.out.println("Autorunner QM Setup");
		...
		System.out.println("Save Member with " + student.getEmail() + "(" + student.getId() + ")");
